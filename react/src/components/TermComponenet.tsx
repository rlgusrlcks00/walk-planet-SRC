...
const TermComponenet = () => {
  return (
    <>
      <Typography gutterBottom>
        <strong>제1조(목적)</strong>
        <br />
        박기찬(이하 &apos;회사&apos;라고 함)는 회사가 제공하고자 하는
        서비스(이하 &apos;회사 서비스&apos;)를 이용하는 개인(이하
        &apos;이용자&apos; 또는 &apos;개인&apos;)의 정보(이하
        &apos;개인정보&apos;)를 보호하기 위해, 개인정보보호법, 정보통신망 이용
        촉진 및 정보보호 등에 관한 법률(이하 &apos;정보통신망법&apos;) 등 관련
        법령을 준수하고, 서비스 이용자의 개인 정보 보호 관련한 고층을 신속하고
      ...
      <Typography gutterBottom>
        ...
        회사는 수집한 이용자의 개인정보를 사전에 개인의 동의 없이 제 3자에게
        제공할 수도 있습니다.
      </Typography>
      <Typography gutterBottom>
        ...
        홈페이지 첫 화면 또는 펏 화면과의 연결화면을 통해 방침을 공개하고
        있습니다.
        <br />
      ...
      <Typography gutterBottom>
        <strong>제5조(회언 가입을 위한 정보)</strong>
        <br />
        ...
        <br />
        2. 선택 수집 정보: 닉네임, 생년월일, 키, 몸무게
      </Typography>
      <Typography gutterBottom>
        <strong>제6조(서비스 이용 및 부정 이용 확인을 위한 정보)</strong>
        <br />
        회사는 이용자의 서비스 이용에 따른 통계.분석 및 부정이용의 확인.분석을
        위하여 다음과 같은 정보를 수집합니다.
        <br />
        (부정이용이란 회원 탈퇴 후 재가입, 상품구매 후 구매 취소 등을 반복적으로
        행하는 등 회사가 제공하는 할인쿠폰, 이벤트 혜택 등의 경제상 이익을
        불.편법적으로 수취하는 행위, 이용약관 등 에서 금지하고 있는 행위,
        명의도용 등의 불.편법적행위 등을 말합니다.)
        <br />
        1. 필수 수집 정보: 서비스 이용기록, 쿠키 및 접속지 정보
      </Typography>
      <Typography gutterBottom>
        <strong>제7조(개인정보 수집 방법)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제9조(사전동의 등에 따른 개인정보의 제공)</strong>
        <br />
        1. 회사는 개인정보 제3자 제공 금지에도 불구하고, 이용자가 사전에
        공개하거나 다음 각호 사항에 대하여 동의한 경우에는 제3자에게 개인정보를
        제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로
        개인정보를 제공합니다.
        <br />
        2. 회사는 전향의 제3자 제공 관계에 변화가 있거나 제3자 제공 관계가
        종결될 때도 같은 절차에 의해 이용자에게 고지 및 동의를 구합니다.
      </Typography>
      <Typography gutterBottom>
        <strong>제10조(개인정보의 보유 및 이용기간)</strong>
        <br />
        1. 회사는 이용자의 개인정보에 대해 개인정보의 수집.이용 목적 달성을 위한
        기간 동안 개인정보를 보유 및 이용합니다.
        <br />
        2. 전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정
        가입 및 이용방지를 위하여 회원 탈퇴 시점으로부터 최대 1년간 보관합니다.
      </Typography>
      <Typography gutterBottom>
        <strong>제11조(법령에 따른 개인정보의 보유 및 이용기간)</strong>
        <br />
        회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.
        <br />
        1. 전자상거래 등에서의 소비자 보호에 관한 법률에 따른 보유정보 및
        보유기간
        <br />
      ...
      <Typography gutterBottom>
        <strong>제12조(개인정보의 파기 원칙)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제13조(개인정보파기절차)</strong>
        <br />
        1. 이용자 회원가입 등을 위해 입력한 정보는 개인정보 처리 복적이 달성된
      ...
      <Typography gutterBottom>
        <strong>제14조(개인정보파기방법)</strong>
        <br />
        회사는 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적
        방법을 사용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나
        소각 등을 통하여 파기합니다.
      </Typography>
      <Typography gutterBottom>
        <strong>제15조(광고성 정보의 전송 조치)</strong>
        <br />
        1. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는
        경우 이용자의 명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에
        해당하는 경우에는 사전 동의를 받지 않습니다.
        <br />
        가. 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한
        경우, 거래가 종료된 날로부터 6개월 이내에 회사가 처리하고 수신자와
        거래한 것과 동종의 재화 등에 대한 영리목적의 광고성 정보를 전송하려는
        경우
        <br />
        나. [방문판매 등에 관한 법률] 에 따른 전화권유 판매자가 육성으로
        수신자에게 개인정보의 수집출처를 고지하고 전화권유를 하는 경우
        <br />
        2. 회사는 전항에도 불구하고 수신자가 수신거부의사를 표시하거나 사전
        동의를 철회한 경우에는 영리목적의 광고성 정보를 전송하지 않으며 수신거부
        및 수신동의 철회에 대한 처리 결과를 알립니다.
        <br />
        3. 회사는 오후 9시부터 그다음 날 오전 8시까지의 시간에 전자적 전송매체를
      ...
      <Typography gutterBottom>
        <strong>제16조(개인정보 조회 및 수집동의 철회)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제17조(개인정보 정보변경 등)</strong>
        <br />
        1. 이용자는 회사에게 전조의 방법을 통해 개인정보의 오류에 정정을 요청할
        수 있습니다.
        <br />
      ...
      <Typography gutterBottom>
        <strong>제19조(회사의 개인정보 관리)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제24조(개인정보 유출 등에 대한 조직)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제25조(개인정보 유출 등에 대한 조치의 예외)</strong>
        <br />
      ...
      <Typography gutterBottom>
        <strong>제26조(국외 이전 개인정보의 보호)</strong>
        <br />
        1. 회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를
        위반하는 사항을 내용으로 하는 국제 계약을 체결하지 않습니다.
        <br />
        2. 회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를 포함)
        .처리위탁.보관(이하 &quot;이전이라 함) 하려면 공개하거나 전자우편 등
        대통령령으로 정하는 방법에 따라 이용자에게 알린 경우에는 개인정보 처리
        위탁.보관에 따른 동의절차를 거치지 아니할 수 있습니다.
        <br />
        3. 회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항
        모두를 이용자에게 고지합니다.
        <br />
        가. 이전되는 개인정보 항목
        <br />
        나. 개인정보가 이전되는 국가, 이전일시 및 이전 방법
        <br />
        다. 개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및 정보관리
        책임자의 연락처를 말한다.)
        <br />
        라. 개인정보를 이전받는 자의 개인정보 이용목적 및 보유.이용기간
        <br />
        4. 회사는 본조 제2항 본문에 따른 동의를 받아 개인정보를 국외로 이전하는
        경우 개인정보보호법 대통령령 등 관계법규에서 정하는 바에 따라 보호조치를
        합니다.
      </Typography>
      <Typography gutterBottom>
        <strong>
        ...
        <br />
        1. 회사는 이용자에게 개별적인 맞춤 서비스를 제공하기 위해 이용 정보를
      ...
      <Typography gutterBottom>
        <strong>제28조(쿠키 설치 허용 지정 방법)</strong>
        <br />
        ...
        쿠키 및 기타 사이트 데이터
        <br />
        3. Whale: 웹브라우저 우측 상단의 설정 메뉴 &gt; 개인정보 보호 &gt; 쿠키
        및 기타 사이트 데이터
      </Typography>
      <Typography gutterBottom>
        ...
        정정.삭제), 제37조(개인정보의 처리 정지 등)의 규정에 의한 요구에 대 하여
      ...
      <Typography gutterBottom>
        <strong>부칙</strong>
        <br />
        제1조 본 방침은 2024.08.13부터 시행됩니다.
      </Typography>
    </>
  );
};

export default memo(TermComponenet);
